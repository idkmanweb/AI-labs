...
def zad2_two_layer_net(student_id):
    ...
    model.hidden_layer.W[:, 0] = [0.01, 0]      # wagi neuronu h1
    model.hidden_layer.W[:, 1] = [-0.01, 0]      # wagi neuronu h2
    model.hidden_layer.b[:] = [-0.0002, 0.01]         # biasy neuronów h1 i h2
...
if __name__ == '__main__':
    ...
    student_id = 193382         # Twój numer indeksu, np. 102247
