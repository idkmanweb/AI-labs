...
class AlphaBetaAgent:
    ...
    def m(self, connect4, x, depth, alpha, beta):
        if depth == 0:
            res = 0
        ...
        if connect4.game_over:
            ...
            if x == 1:
                ...
                for drop in connect4.possible_drops():
                    ...
                    s_res, _ = self.m(connect4copy, 0, depth-1, alpha, beta)
                    if s_res > best_m:
                        best_m = s_res
                        all_m = [drop]
                        if s_res > alpha:
                ...
                for drop in connect4.possible_drops():
                    connect4copy = copy.deepcopy(connect4)
                    connect4copy.drop_token(drop)
                    s_res, _ = self.m(connect4copy, 1, depth-1, alpha, beta)
                    if s_res < best_m:
                        best_m = s_res
                        all_m = [drop]
                        if s_res < beta:
    ...
    def decide(self, connect4):
        ...
        _, move = self.m(connect4, 1, 5, -2, 2)
